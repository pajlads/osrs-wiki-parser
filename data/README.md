Data contains some static data from the OSRS wiki https://oldschool.runescape.wiki/w/RuneScape:About

`optimal-quest-guide.json` contains an array of quest names in the order of the optimal quest guide https://oldschool.runescape.wiki/w/Optimal_quest_guide
